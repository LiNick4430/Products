...
(1, 'ROLE_PUBLIC', '普通民眾', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'ROLE_STAFF', '基層人員', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'ROLE_MANAGER', '高階主管', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(101, 'ANNOUNCEMENT_READ', '系統公告', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(102, 'ORGANIZATION_READ', '機構介紹', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(103, 'PUBLIC_USER_CREATE', '帳號註冊', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(104, 'CREATE_CASE', '線上申辦-申請', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(105, 'WITHDRAWAL_REQUESTS', '線上申辦-撤銷', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- 後台 - 基層工作人員
(201, 'ANNOUNCEMENT_MANAGE', '公告管理 (新增/修改/刪除)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(202, 'ORGANIZATION_MANAGE', '機構管理 (新增/修改/刪除)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(203, 'CLASS_MANAGE', '班級管理 (新增/修改/刪除)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(204, 'CASE_AUDIT', '申請審核', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(205, 'WITHDRAWAL_AUDIT', '撤銷審核', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(206, 'WAITLIST_READ', '候補清冊', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(207, 'CASE_MANAGEMENT', '個案管理 (錄取/退托)', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- 後台 - 高階主管人員
(301, 'USER_PUBLIC_MANAGE', '民眾帳號管理', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(302, 'USER_ADMIN_MANAGE', '後臺帳號管理', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(303, 'REGULATION_MANAGE', '規範說明管理', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(304, 'LOTTERY_QUEUE', '補位抽籤執行', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- 1. 北區-陽光寶貝公托
( 1, '台中市北區陽光寶貝公托家園', '致力於提供溫馨、安全的環境，以遊戲啟發幼兒潛能。', '台中市北區學士路100號', '04-22001111', 'sunshine.ntc@daycare.gov.tw', '04-22001112',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP ),
-- 2. 西屯區-彩虹幼兒園
( 2, '台中市西屯區彩虹公立幼兒園', '結合自然教學法，培養幼兒獨立思考能力，近公園綠地。', '台中市西屯區台灣大道三段300號', '04-23002222', 'rainbow.wtc@daycare.gov.tw', '04-23002223',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP ),
-- 3. 南區-智慧樹公托
(3, '台中市南區智慧樹社區公托', '專注於幼兒早期教育與感統訓練，提供專業的師資團隊。', '台中市南區復興路一段50號', '04-24003333', 'wisdom.stc@daycare.gov.tw', '04-24003334',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP ),
-- 4. 豐原區-愛心幼兒園
(4, '台中市豐原區愛心公立幼兒園', '在地深耕，提供親切且互動性高的學習環境，服務豐原家庭。', '台中市豐原區中正路20號', '04-25004444', 'love.fyc@daycare.gov.tw', '04-25004445',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP );
...
('staff_d@system.com', '0950555551', 'staff_d', '$2a$10$rP1yhH20.2AA/WlMaNnyTeO2U.tbc0WnORGFWo7anPpColB7NBGrK', TRUE, 2,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- 6-10. 民眾帳號 (ROLE_ID = 1)
...
-- 2. 員工 A (Staff A)
(2, '員工甲', '專員', 1 ,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- 3. 員工 B (Staff B)
(3, '員工乙', '專員', 2 ,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- 4. 員工 C (Staff C)
(4, '員工丙', '專員', 3 ,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- 5. 員工 D (Staff D)
(5, '員工丁', '專員', 4 ,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(6, '林雅雯', 'B234567892', '1992-05-15', '臺中市北區三民路三段129號', '臺中市北區進化路400號5樓', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(7, '黃子軒', 'C345678903', '1978-08-01', '臺中市南屯區公益路二段51號', '臺中市南屯區文心路一段200號10樓', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(8, '張靜宜', 'D456789014', '2001-02-28', '臺中市東區復興路四段186號', '臺中市東區大勇街10巷8號', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(9, '李冠霖', 'E567890125', '1965-04-10', '臺中市豐原區中正路288號', '臺中市豐原區圓環東路150巷9號', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(10, '王怡萱', 'F678901236', '1998-12-05', '臺中市大里區國光路二段710號', '臺中市大里區德芳南路300號', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
-- 公民 6：林雅雯
('張以萱', 'H234567812', '2021-09-18', '女', 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('張以晨', 'H345678923', '2023-04-02', '男', 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- 公民 7：黃子軒
('黃宥睿', 'J123456784', '2020-12-10', '男', 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- 公民 8：張靜宜
('陳芷晴', 'K567890126', '2022-07-25', '女', 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('陳芷語', 'K678901237', '2024-01-14', '女', 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- 公民 9：李冠霖
('李柏睿', 'L789012348', '2019-03-22', '男', 9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- 公民 10：王怡萱
('林品希', 'M890123459', '2020-10-02', '女', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('林品諾', 'M901234560', '2023-03-30', '男', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
('12 月份課程通知',
 ...
 '2025-12-01', true, '2025-12-31', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('春季戶外教學報名開始',
 '本次將至動物園進行戶外教學，請於 3/10 前完成報名。',
 '2025-02-25', true, '2025-03-15', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('四月份活動預告（草稿）',
 '4 月預計舉辦親子運動日，細節將於定案後公告。',
 NULL, false, NULL, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- ======== 機構 2 ========
('園區設備年度消毒',
 '本園將於 12/10 全面消毒，當日不開放參觀，敬請配合。',
 '2025-12-3', true, '2025-12-17', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('午餐菜單更新公告',
 '四月起午餐改採新供應商，菜色更均衡，請家長放心。',
 '2025-03-02', true, '2025-04-30', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('招生說明會（草稿）',
 '預計於 5 月舉辦招生說明會，內容尚在修訂中。',
 NULL, false, NULL, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
('校園安全宣導週',
 ...
 '2025-11-30', true, '2025-12-07', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('停水通知',
 '因區域性檢修，3/12 上午部分設施停止供水，但課程照常進行。',
 '2025-03-08', true, '2025-03-12', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('家長會議（草稿）',
 '家長會議初步規劃於 4/20 舉行，細節將後續公布。',
 NULL, false, NULL, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

-- ======== 機構 4 ========
('春假行前提醒',
 '春假期間請家長留意幼兒作息與安全，假期後正常開課。',
 '2025-03-20', true, '2025-03-31', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('新學期注意事項',
 '新學期將啟用新版聯絡簿，請家長於第一週協助填寫資訊。',
 '2025-02-15', true, '2025-04-01', 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

('課後才藝課程調整（草稿）',
 '部分才藝課程正在調整師資與時段，尚未對外公布。',
 NULL, false, NULL, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
