...
('12 月份課程通知',
 ...
 '2025-12-01', true, '2025-12-31', 1, NOW(), NOW()),
...
('園區設備年度消毒',
 ...
 '2025-12-3', true, '2025-12-17', 2, NOW(), NOW()),
...
('校園安全宣導週',
 ...
 '2025-11-30', true, '2025-12-07', 3, NOW(), NOW()),
...
admin_documentadmin_document
-- ======== 機構 4 ========
('春假行前提醒',
 '春假期間請家長留意幼兒作息與安全，假期後正常開課。',
 '2025-03-20', true, '2025-03-31', 4, NOW(), NOW()),
