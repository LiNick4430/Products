...
public class PasswordSecurity {
	...
	public static void main(String[] args) {
		...
		// 檢測看看 是否相符
		System.out.println(String.valueOf(verifyPassword(password, hash)));		// true
		System.out.println(String.valueOf(verifyPassword(password, hash2)));	// false
		System.out.println(String.valueOf(verifyPassword(password2, hash)));	// false
		System.out.println(String.valueOf(verifyPassword(password2, hash2)));	// true
	}
}
